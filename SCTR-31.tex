...
telemetry being published to the EFD will be checked through the use of
a python notebook to be consistent with the information being displayed
on the EUI and on the output binary file. After the telemetry is seen to
be consistent, we will verify the telemetry topics listed in the test
steps have all been accurately published.}{\\
}
