...
requirement specified in \citeds{LTS-146}. This test case will test that the
actuators do not require power to maintain their set positions and
forces using the closed-loop controller.~}
...
meet the accuracy and repeatability requirements
...
correctly.\\
This test case also verifies the proper operation of the M2 cart.
