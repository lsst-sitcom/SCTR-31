...
\end{minipage}
\\ \hline
\href{https://jira.lsstcorp.org/secure/Tests.jspa#/testCase/LVV-T1828}{LVV-T1828}
& {\small Bo Xin } & {\small  } &
\begin{minipage}[]{6cm}
\smallskip
{\small  }
...
\paragraph{ LVV-T1828 - M2 Tangential Loading }\mbox{}\\

Version \textbf{1}.
Open  \href{https://jira.lsstcorp.org/secure/Tests.jspa#/testCase/LVV-T1828}{\textit{ LVV-T1828 } }
test case in Jira.
...
test procedure of the M2 LUT (cart rotation) test case, but while the M2
cart is elevated. Specifically, the side perpendicular to the tangential
links A1 and A4 of the M2 cart will be lifted by a \textbf{TBD~}amount
in order to simulate the tangential loads that will be on the telescope.
This test case will exercise this functionality and meets the following
criteria:
