...
procedural documents are the \emph{Bosch Task Testing Plan, TMA -
Commanding through the EUI - CCW Tests, CCW - Bosch Power Supply Task
Testing Plan~}and the \emph{CCW Aux Temperature Control Task Testing
Plan.~}All of the results from these procedures will be recorded in this
test case.~
