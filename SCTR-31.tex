...
is~\href{https://github.com/lsst-ts/ts_mtm2/blob/master/doc/project/CellConfiguration.xlsx}{CellConfiguration.xlsx}
    ...
    \begin{minipage}[]{9cm}
    \smallskip
    +x motion limit =0.87mm, while \citeds{LTS-146} has 7.74mm
    \medskip
    \end{minipage}
    &
    \\\hline
...
the EUI, make sure they make sense. Take screen shots\\
...
change in EFD, 21:49 utc\\[2\baselineskip]
...
3 & Description \\
 & \begin{minipage}[t]{15cm}
{\footnotesize
power down the system so that it is done writing to the binary file.
...
verify that the inner control loop applies motor steps as commanded by
...
4 & Description \\
 & \begin{minipage}[t]{15cm}
{\footnotesize
repeat the steps 3-4 by 40,60,80,100 Newtons
...
Note the readings of the position sensors
...
2:58pm local, we are back to do de-energization. reapplied bm1, 500nm.
...
3 & Description \\
 & \begin{minipage}[t]{15cm}
{\footnotesize
de-energize the actuators, wait for 32s
...
1 & Description \\
 & \begin{minipage}[t]{15cm}
{\footnotesize
loop over every actuator, apply 20N, clear, -20N, clear, then go to the
next actuator\\
Note: if the change of forces is happening too fast and telemetry
doesn't keep up, consider apply each force twice in a row?
...
{\footnotesize
data analysis:\\
check force repeatability, and force error.\\
...
Final comment:\\+x motion limit =0.87mm, while \citeds{LTS-146} has 7.74mm
...
move to x=7mm,\\
then x=7.1mm, keep moving with increment of 0.1mm, observe at what point
system goes into fault.\\
...
these limits (to 3mm in each direction) before we set it back to
default. But Te-Wei noted that these are hardcoded somewhere and hard to
find.
...
9:49pm, go to z=-4mm. It stopped at z=-3.75299mm.
...
\end{minipage} \\ \cdashline{2-2}
 ...
 & Actual Result \\
 & \begin{minipage}[t]{15cm}{\footnotesize
12:22pm, switched to open loop, then closed loop.\\
...
(2) GuI has unit wrong, mm is really center.\\
...
\end{minipage} \\ \cdashline{2-2}
 ...
 & Actual Result \\
 & \begin{minipage}[t]{15cm}{\footnotesize
6:05pm 3/4/20. entered open loop mode
...
\end{minipage} \\ \cdashline{2-2}
 ...
 & Actual Result \\
 & \begin{minipage}[t]{15cm}{\footnotesize
cannot add forces in open loop.~
...
\end{minipage} \\ \cdashline{2-2}
 ...
 & Actual Result \\
 & \begin{minipage}[t]{15cm}{\footnotesize
use fb.m to create csv files. sent to Te-Wei.\\
fbA1m.csv 6:37pm local time. verified on Chronograf, A1 force drops from
40 N to 30N\\
fbA1p.csv 6:39pm local, but didn't clear the -20N. so, open loop, close
loop, do it again at 6:42pm\\
fbA3m.csv 6:43pm. clear by open and close loop.\\
fbA3p.csv 6:44. clear by \ldots{}.\\
fbA5m.csv 6:45 clear \ldots{}\\
fbA5p.csv 6:46. clear \ldots{}\\
fbB3m.csv 6:47 clear \ldots{}\\
fbB3p.csv 6:48 clear \ldots{}.\\
fbC8m.csv 6:49 clear \ldots{}\\
fbC8p.csv 6:50 clear \ldots{}\\
fbD17m.csv 6:51 clear \ldots{}\\
fbD17p.csv 6:53 clear \ldots{}
...
\end{minipage} \\ \cdashline{2-2}
 ...
 & Actual Result \\
 & \begin{minipage}[t]{15cm}{\footnotesize
\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testPlayer/testExecution/LVV-E1003}{LVV-E1003}
...
7 & Description \\
 & \begin{minipage}[t]{15cm}
{\footnotesize
If time allows, redefine the 3 axial actuators used as hard points. Redo
the above test.
...
4:03pm, -0.7mm\\
+0.35pm B15 = -75N, norminal is about 185N.\\
