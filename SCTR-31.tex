...
\paragraph{Test Case LVV-T1787 - M2 LUT (cart rotation) }\mbox{}\\
...
correctly.\\
This test case also verifies the proper operation of the M2 cart, and
that the M2 inclinometer works properly and the read out is used
properly in the Look-Up Table.\\[3\baselineskip]{The objective of this
test case it to re-verify the requirements specified in \citeds{LTS-146}
regarding the forces of the M2 support system. This test case will first
test that the actuators are applying the correct forces according to the
Look-Up Table through the M2 cart's entire range of motion. This test
case should show that the LUT forces are being updated at 20Hz and
safely support the mirror. In addition, the M2 inclinometer data should
show consistency to that of the M2 cart control and zenith angles
displayed on the GUI.~}\\[2\baselineskip]{Version 1 - No elevation}\\
{Version 2 - Elevated}
