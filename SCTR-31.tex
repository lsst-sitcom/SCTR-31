...
T14900-1001 page 9, the close loop seem to mean the force loop is closed
when the inclination angle and temperature changes.\\
temperature data in EFD: there are 72 fields, but only 16 sensors. Need
to do LCR to change XML and sal\_interface document.\\
Cell temperatures (4 of them) seem to be \textasciitilde{}2C higher than
mirror T (12 of them). Is that what we would expect?\\
zenith angle inconsistency, see detail below\\
...
desired features as well. Te-Wei will circulate.
    \medskip
    \end{minipage}
    &
    \\\hline
...
show 89.50 and 89.57. EFD shows 7.4e-3, no sure about unit.\\
