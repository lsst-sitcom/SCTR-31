...
facility to the Summit facility.~}\\[2\baselineskip]\textbf{{Incorporate
item\#12 from the wishlist. We need to execute this test case before the
M2 reference position and position sensor offset test case. This test
case first verifies that the software for the sensors work
correctly.}}\\
