...
{The objective of this test case is to verify that the inner control
loop applies motor steps as commanded by the EUI.}
...
outer control loop requirements as defined in \citeds{LTS-146} using M2 control
...
of this test case is to test the software limits to only verify that
